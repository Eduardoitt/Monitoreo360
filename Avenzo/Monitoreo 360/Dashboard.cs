    ...
    public partial class Dashboard : MetroFramework.Forms.MetroForm
    {
        ...
        public Dashboard(Guid IdUsuario)
        {
            ...
            foreach (var incidente in Incidentes)
            {
                ...
                System.Windows.Forms.Button Notificacion1 = new System.Windows.Forms.Button();
        ...
        {
            Monitor_ form = new Monitor_(Idusuario, this.panel_Notificaciones, this.Button_Badge);
            form.MdiParent = this;
            form.Show();
        }
