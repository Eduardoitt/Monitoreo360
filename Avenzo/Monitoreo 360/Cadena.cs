    ...
    public partial class Cadena : UserControl
    {
        ...
        public void IngresarCadena(string Cadena)
        {
            if (Cadena.Length > 30)
            {
                try
                {
                    string f = Cadena.Substring(0, 20);
                    DateTime fecha = DateTime.Parse(f);
                    f = Cadena.Substring(23, 20).Replace("-", " ");
                    DateTime fecha2 = DateTime.Parse(f);
                    string NumeroTelefono = Cadena.Substring(54, 6).Replace("-", "");
                    string NumeroCuenta = Cadena.Substring(61, 4);
                    string report = Cadena.Substring(66, Cadena.Length - 66);
