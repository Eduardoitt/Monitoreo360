...
namespace TestApp
{
    class myGroupBox : GroupBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawPath(new Pen(Color.FromArgb(192,37,30),3), gPath);

            borderRect.X += 6;
            borderRect.Y -= 7;

            e.Graphics.DrawString(this.Text, this.Font, new SolidBrush(Color.FromArgb(192, 37, 30)), borderRect);
        }
